...
const Presentation = React.lazy(() => import('./views/Presentation/presentation'));
...
const routes = [
  ...
  { path: '/presentation/presentation', exact: true, name: 'Presentación', component: Presentation }
];
